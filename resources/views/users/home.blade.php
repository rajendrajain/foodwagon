                  ...
                  <div class="carousel-item active" data-bs-interval="10000">
                    <div class="row gx-3  align-items-center">
                      <div class="col-sm-6 col-md-4 col-xl mb-5 ">
                        <div class="card card-span  rounded-3"><img class="img-fluid rounded-3 " src="assets/img/gallery/cheese-burger.png" alt="..." />
                      ...
                      <div class="col-sm-6 col-md-4 col-xl mb-5 ">
                        <div class="card card-span  rounded-3"><img class="img-fluid rounded-3 " src="assets/img/gallery/toffes-cake.png" alt="..." />
                          <div class="card-body ps-0">
                      ...
                      <div class="col-sm-6 col-md-4 col-xl mb-5 ">
                        <div class="card card-span  rounded-3"><img class="img-fluid rounded-3 " src="assets/img/gallery/dancake.png" alt="..." />
                          <div class="card-body ps-0">
                      ...
                      <div class="col-sm-6 col-md-4 col-xl mb-5 ">
                        <div class="card card-span  rounded-3"><img class="img-fluid rounded-3 " src="assets/img/gallery/crispy-sandwitch.png" alt="..." />
                          <div class="card-body ps-0">
                      ...
                      <div class="col-sm-6 col-md-4 col-xl mb-5 ">
                        <div class="card card-span  rounded-3"><img class="img-fluid rounded-3 " src="assets/img/gallery/thai-soup.png" alt="..." />
                          <div class="card-body ps-0">
        ...
        <div class="container">
          ...
          <div class="row gx-2">
            <div class="col-sm-6 col-md-4 col-lg-3  mb-5">
              <div class="card card-span  text-white rounded-3"><img class="img-fluid rounded-3 " src="assets/img/gallery/food-world.png" alt="..." />
            ...
            <div class="col-sm-6 col-md-4 col-lg-3  mb-5">
              <div class="card card-span  text-white rounded-3"><img class="img-fluid rounded-3 " src="assets/img/gallery/pizza-hub.png" alt="..." />
            ...
            <div class="col-sm-6 col-md-4 col-lg-3  mb-5">
              <div class="card card-span  text-white rounded-3"><img class="img-fluid rounded-3 " src="assets/img/gallery/donuts-hut.png" alt="..." />
            ...
            <div class="col-sm-6 col-md-4 col-lg-3  mb-5">
              <div class="card card-span  text-white rounded-3"><img class="img-fluid rounded-3 " src="assets/img/gallery/donuthut.png" alt="..." />
                <div class="card-img-overlay ps-0"><span class="badge bg-danger p-2 ms-3"><i class="fas fa-tag me-2 fs-0"></i><span class="fs-0">15% off</span></span><span class="badge bg-primary ms-2 me-1 p-2"><i class="fas fa-clock me-1 fs-0"></i><span class="fs-0">Fast</span></span></div>
                <div class="card-body ps-0">
            ...
            <div class="col-sm-6 col-md-4 col-lg-3  mb-5">
              <div class="card card-span  text-white rounded-3"><img class="img-fluid rounded-3 " src="assets/img/gallery/ruby-tuesday.png" alt="..." />
                <div class="card-img-overlay ps-0"><span class="badge bg-danger p-2 ms-3"><i class="fas fa-tag me-2 fs-0"></i><span class="fs-0">10% off</span></span><span class="badge bg-primary ms-2 me-1 p-2"><i class="fas fa-clock me-1 fs-0"></i><span class="fs-0">Fast</span></span></div>
                <div class="card-body ps-0">
            ...
            <div class="col-sm-6 col-md-4 col-lg-3  mb-5">
              <div class="card card-span  text-white rounded-3"><img class="img-fluid rounded-3 " src="assets/img/gallery/kuakata.png" alt="..." />
                <div class="card-img-overlay ps-0"><span class="badge bg-danger p-2 ms-3"><i class="fas fa-tag me-2 fs-0"></i><span class="fs-0">10% off</span></span><span class="badge bg-primary ms-2 me-1 p-2"><i class="fas fa-clock me-1 fs-0"></i><span class="fs-0">Fast</span></span></div>
                <div class="card-body ps-0">
            ...
            <div class="col-sm-6 col-md-4 col-lg-3  mb-5">
              <div class="card card-span  text-white rounded-3"><img class="img-fluid rounded-3 " src="assets/img/gallery/red-square.png" alt="..." />
                <div class="card-img-overlay ps-0"><span class="badge bg-danger p-2 ms-3"><i class="fas fa-tag me-2 fs-0"></i><span class="fs-0">10% off</span></span><span class="badge bg-primary ms-2 me-1 p-2"><i class="fas fa-clock me-1 fs-0"></i><span class="fs-0">Fast</span></span></div>
                <div class="card-body ps-0">
            ...
            <div class="col-sm-6 col-md-4 col-lg-3  mb-5">
              <div class="card card-span  text-white rounded-3"><img class="img-fluid rounded-3 " src="assets/img/gallery/taco-bell.png" alt="..." />
                <div class="card-img-overlay ps-0"><span class="badge bg-danger p-2 ms-3"><i class="fas fa-tag me-2 fs-0"></i><span class="fs-0">10% off</span></span><span class="badge bg-primary ms-2 me-1 p-2"><i class="fas fa-clock me-1 fs-0"></i><span class="fs-0">Fast</span></span></div>
                <div class="card-body ps-0">
                ...
                <div class="carousel-inner">
                  <div class="carousel-item active" data-bs-interval="10000">
                    <div class="row  align-items-center">
                      <div class="col-sm-6 col-md-4 col-xl mb-5 ">
                        <div class="card card-span  rounded-circle"><img class="img-fluid rounded-circle " src="assets/img/gallery/search-pizza.png" alt="..." />
                          <div class="card-body ps-0">
                      ...
                      <div class="col-sm-6 col-md-4 col-xl mb-5 ">
                        <div class="card card-span  rounded-circle"><img class="img-fluid rounded-circle " src="assets/img/gallery/burger.png" alt="..." />
                          <div class="card-body ps-0">
                      ...
                      <div class="col-sm-6 col-md-4 col-xl mb-5 ">
                        <div class="card card-span  rounded-circle"><img class="img-fluid rounded-circle " src="assets/img/gallery/noodles.png" alt="..." />
                          <div class="card-body ps-0">
                      ...
                      <div class="col-sm-6 col-md-4 col-xl mb-5 ">
                        <div class="card card-span  rounded-circle"><img class="img-fluid rounded-circle " src="assets/img/gallery/sub-sandwich.png" alt="..." />
                          <div class="card-body ps-0">
                      ...
                      <div class="col-sm-6 col-md-4 col-xl mb-5 ">
                        <div class="card card-span  rounded-circle"><img class="img-fluid rounded-circle " src="assets/img/gallery/chowmein.png" alt="..." />
                          <div class="card-body ps-0">
                      ...
                      <div class="col-sm-6 col-md-4 col-xl mb-5 ">
                        <div class="card card-span  rounded-circle"><img class="img-fluid rounded-circle " src="assets/img/gallery/steak.png" alt="..." />
                          <div class="card-body ps-0">
            ...
            <div class="col-12">
              <div class="card card-span mb-3 shadow-lg">
                <div class="card-body py-0">
                  <div class="row justify-content-center">
                    <div class="col-md-5 col-xl-7 col-xxl-8 g-0 order-0 order-md-1"><img class="img-fluid w-100 fit-cover  rounded-top rounded-md-end rounded-md-top-0" src="assets/img/gallery/crispy-sandwiches.png" alt="..." /></div>
          ...
          <div class="row">
            <div class="col-12">
              <div class="card card-span mb-3 shadow-lg">
                <div class="card-body py-0">
                  <div class="row justify-content-center">
                    <div class="col-md-5 col-xl-7 col-xxl-8 g-0 order-md-0"><img class="img-fluid w-100 fit-cover  rounded-top rounded-md-start rounded-md-top-0" src="assets/img/gallery/fried-chicken.png" alt="..." /></div>
                    <div class="col-md-7 col-xl-5 col-xxl-4 p-4 p-lg-5">
          ...
          <div class="row">
            <div class="col-12">
              <div class="card card-span mb-3 shadow-lg">
                <div class="card-body py-0">
                  <div class="row justify-content-center">
                    <div class="col-md-5 col-xl-7 col-xxl-8 g-0 order-0 order-md-1"><img class="img-fluid w-100 fit-cover  rounded-top rounded-md-end rounded-md-top-0" src="assets/img/gallery/pizza.png" alt="..." /></div>
                    <div class="col-md-7 col-xl-5 col-xxl-4 p-4 p-lg-5">
